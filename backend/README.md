...
## Project Structure
    ...
    ├── testapiautosettings_57815  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_57815`
...
2. Clone this repo and `cd testapiautosettings_57815`
